...
function Dish() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:4000/restaurant/dishs")
      .then((res) => {
        const dishs = [];
  ...
  useEffect(() => {
    axios
      .get("http://localhost:4000/restaurant/bill")
      .then((res) => {
        const bill = res.data;
        setListBill(bill.results);
      })
    ...
    if (numberPhoneCustomer.length > 9) {
      listBill.forEach((bill) => {
        if (bill.phoneNumber === numberPhoneCustomer) {
          ...
          if (!countDish) {
            message.error(
              "Món ăn không có trong danh sách các món được đặt",
              3
            );
          }
        } else {
  ...
  const background = {
    backgroundImage:
      "url(https://cdn.daynauan.info.vn/wp-content/uploads/2019/05/suon-non-kho-nuoc-dua.jpg)",
  };
  ...
  const onSetChangeStarUpdate = (data) => {
    axios
      .patch("http://localhost:4000/restaurant/dishs", data)
      .then((res) => {
        setDishPic();
      })
      .catch((error) => {
      ...
      .then((res) => {
        ...
        res.data.results.forEach((element) => {
          if (element.lable === dishPic.lable) {
            if (starEvaluate == 1) {
              var evaluatetemp =
                parseInt(element.star1) +
                1 +
                parseInt(element.star2) +
                parseInt(element.star3) +
                parseInt(element.star4) +
                parseInt(element.star5);
              var numberStar =
                parseInt(element.star1) +
                1 +
                parseInt(element.star2) * 2 +
                parseInt(element.star3) * 3 +
                parseInt(element.star4) * 4 +
                parseInt(element.star5) * 5;
              ...
              var evaluatetemp =
                parseInt(element.star1) +
                (parseInt(element.star2) + 1) +
                parseInt(element.star3) +
                parseInt(element.star4) +
                parseInt(element.star5);
              var numberStar =
                parseInt(element.star1) +
                (parseInt(element.star2) + 1) * 2 +
                parseInt(element.star3) * 3 +
                parseInt(element.star4) * 4 +
                parseInt(element.star5) * 5;
              onSetChangeStarUpdate({
              ...
              var evaluatetemp =
                parseInt(element.star1) +
                parseInt(element.star2) +
                (parseInt(element.star3) + 1) +
                parseInt(element.star4) +
                parseInt(element.star5);
              var numberStar =
                parseInt(element.star1) +
                parseInt(element.star2) * 2 +
                (parseInt(element.star3) + 1) * 3 +
                parseInt(element.star4) * 4 +
                parseInt(element.star5) * 5;
              onSetChangeStarUpdate({
                content: element.content,
              ...
              var evaluatetemp =
                ...
                parseInt(element.star2) +
                parseInt(element.star3) +
                (parseInt(element.star4) + 1) +
                parseInt(element.star5);
              var numberStar =
                parseInt(element.star1) +
                parseInt(element.star2) * 2 +
                parseInt(element.star3) * 3 +
                (parseInt(element.star4) + 1) * 4 +
                parseInt(element.star5) * 5;
              onSetChangeStarUpdate({
                content: element.content,
                dislike: element.dislike,
              ...
              var evaluatetemp =
                ...
                parseInt(element.star3) +
                parseInt(element.star4) +
                (parseInt(element.star5) + 1);
              var numberStar =
                parseInt(element.star1) +
                parseInt(element.star2) * 2 +
                parseInt(element.star3) * 3 +
                parseInt(element.star4) * 4 +
                (parseInt(element.star5) + 1) * 5;
              onSetChangeStarUpdate({
                content: element.content,
                dislike: element.dislike,
                evaluate: (numberStar / evaluatetemp).toFixed(1),
  ...
  const onSubmitComment = () => {
    if (commentCustomer === "") {
      ...
      axios
        .put("http://localhost:4000/restaurant/commentDish", {
              ...
              {dishPic ? (
                dishPic.lable == dishs.lable ? (
                  <div style={{ width: "85%", marginLeft: "5%", zIndex: "99" }}>
                    ...
                    {/* <hr /> */}
                    <label style={{ color: "white", marginLeft: "10%" }}>
                    ...
                    <input
                      ...
                      onChange={(e) => setNumberPhoneCustomer(e.target.value)}
                    ></input>
                    {evaluate ? (
                      <div>
                        <div
                  ...
                  <div className="content">
                    ...
                    <i style={{ color: "white" }}>{dishs.evaluate}</i>
                    <img
                      src={star}
                      style={{ width: "25px", marginTop: "-5%" }}
                    ></img>
