                    ...
                    <div class="card">
                        <div class="flip-card">
                            <div class="flip-card__container">
                                ...
                                <div class="card-back">
                                <img style={{width:"100%" , height:"100%"}} src='https://bep360.net/wp-content/uploads/2021/06/cach-nau-bun-thang.jpg'></img>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="flip-card">
                            <div class="flip-card__container">
                                ...
                                <div class="card-back">
                                <img style={{width:"100%" , height:"100%"}} src='https://cachnau.vn/wp-content/uploads/2021/11/cach-nau-pho-bo-nam-dinh.jpg'></img>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="inside-page">
                            <div class="inside-page__container">
                                ...
                                <p class="inside-page__text">
                                Vị ngọt ngon đậm đà chuẩn hương vị phở Nam Định                                </p>
                    ...
                    <div class="card">
                        <div class="flip-card">
                            <div class="flip-card__container">
                                ...
                                <div class="card-back">
                                <img style={{width:"100%",height:"100%"}} src='https://nghebep.com/wp-content/uploads/2017/12/ca-hoi-nuong-giay-bac.jpg'></img>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="flip-card">
                            <div class="flip-card__container">
                                ...
                                <div class="card-back">
                                    <img style={{width:"100%"}} src='https://delicacy.vn/resize-image/600x600/thumnail-sun-vi-ca-map.jpg'></img>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="inside-page">
                            <div class="inside-page__container">
                                ...
                                <p class="inside-page__text">
                                Vi cá mập thực phẩm mang nhiều lợi ích cho sức khoẻ !                                </p>
